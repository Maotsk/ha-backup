...
CONF_BACKUP="${HA_BACKUP_CONF:-/root/.ha-backup.conf}"
...
# LOGDIR: сначала из конфига, потом из Environment, потом дефолт
LOGDIR="${LOGDIR:-${HA_BACKUP_LOG_DIR:-/var/log.hdd/ha}}"
